...
import { baseURL, closeBrowser, page, setupTest } from './setup.test'
import {
  addToCart,
  clickBookLink,
  clickElement,
...
describe('Digital Book Shop', () => {
  describe('Signed-out functionality', () => {
    ...
    describe('Remove books from cart', () => {
      it('should remove Wuthering Heights', async () => {
        await clickBookLink('wuthering-heights')
        await verifyButton('cart-button-wuthering-heights', 'Remove from cart')
  ...
  describe('Create account', () => {
    it('should create an account', async () => {
      ...
      await verifyFeedbackMessage('Welcome Test! Your account has been created.')
    })
