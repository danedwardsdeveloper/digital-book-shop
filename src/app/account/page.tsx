...
export default function Account() {
  ...
  return (
    <Container>
      ...
      {hasPurchased ? <PurchaseHistory /> : <h2 className="text-lg font-semibold">No purchases yet</h2>}

      <div className="h-16" />
      <Button text={'Sign out'} variant={'secondary'} onClick={handleSignOut} dataTestID="sign-out-button" />
      <div className="h-16" />
      <div className={clsx('py-4 px-4', 'rounded', 'border border-red-200', 'bg-red-100')}>
